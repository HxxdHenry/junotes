...
function displaySelectedFile() {
    ...
    if (selectedFile) {
        const assignment = assignments.find(assignment => assignment.url === selectedFile);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('assignmentsDropdown').addEventListener('change', displaySelectedFile);
});
